  ...
  <Background color="bg-gray-100">
    <Container title="Footer">
      <CenteredFooter
        iconList={
          <>
            <Link href="https://github.com/AndrewCrescencio" target="_blank">
            ...
            <Link
              href="https://www.linkedin.com/in/andrewcrescencio/"
              target="_blank"
            >
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="mailto:andrew_workstation@hotmail.com" target="_blank">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
